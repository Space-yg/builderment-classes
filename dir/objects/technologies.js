...
import * as other from "./buildings/other.js";
import * as powerPlants from "./buildings/powerPlants.js";
...
export const circuitry = new Technology({
    ...
    unlocks: [item.silicon, item.logicCircuit],
});
export const sand = new Technology({
    name: "Sand",
    price: { gems: 100 },
    image: "https://static.wikia.nocookie.net/builderment/images/a/ad/Sand_tech.png",
    unlocksTechnologies: [],
    resourcesNeeded: [
        {
            item: item.stone,
