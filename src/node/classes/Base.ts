...
export type BaseParams = {
	 ...
	 * @default "https://raw.githubusercontent.com/Space-yg/builderment-assets/refs/heads/main"
	 */
	image?: string
}
...
export class Base {
	...
	constructor(baseOrParams: Base | BaseParams, passByReference: boolean = true) {
		...
		this.image = baseOrParams.image ?? "https://raw.githubusercontent.com/Space-yg/builderment-assets/refs/heads/main/"
