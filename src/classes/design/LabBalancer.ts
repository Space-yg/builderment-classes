...
export class LabBalancer extends Design {
    ...
    static #labBalancers: {[/** The Robotic Arm tier of the lab balancer */ roboticArmTier: number]: LabBalancer[]} = {}
    /**
     * The amount of lab balancers that has been made
     * @readonly
     */
     ...
     * @param options
     */
    constructor(options: Omit<DesignOptions, "category">) {
        super({
            ...options,
        ...
        // Add lab balancer
        if (LabBalancer.#labBalancers[this.requirements.roboticArmTier] === undefined) LabBalancer.#labBalancers[this.requirements.roboticArmTier] = []
