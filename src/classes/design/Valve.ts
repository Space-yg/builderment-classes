...
export class Valve extends Design {
    ...
    static #valves: {[/** The Robotic Arm tier of the valve */ roboticArmTier: number]: Valve[]} = {}
    /**
     * The amount of valves that has been made
     * @readonly
     */
    ...
    constructor(options: Omit<DesignOptions, "category">) {
        ...
        // Add valve
        if (Valve.#valves[this.requirements.roboticArmTier] === undefined) Valve.#valves[this.requirements.roboticArmTier] = []
